...
<head>
    ...
    <title><fmt:message bundle="${lang_bundle}" key="title.create_album"/></title>
...
<div class="content_body">
    <div class="inner_content_container">
        <div class="page_content">
            <h1 class="page_h1"><fmt:message bundle="${lang_bundle}" key="title.create_album"/></h1>
            <form method="post" action="/servlet?cmd=create_album">
