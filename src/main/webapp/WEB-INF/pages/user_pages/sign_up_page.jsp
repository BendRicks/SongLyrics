...
<head>
    ...
    <title><fmt:message bundle="${lang_bundle}" key="header.sign_up"/></title>
...
<div class="content_body">
    <div class="inner_content_container signing_page">
        <h1 class="h1_signing"><fmt:message bundle="${lang_bundle}" key="header.sign_up"/></h1>
        <form action="/servlet?cmd=sign_up" method="post" autocomplete="off" class="signing_form">
            ...
            <input required minlength="8" class="input mt-1" type="password"
                   placeholder="<fmt:message bundle="${lang_bundle}" key="user_page.password_rep"/>"
                   name="password_repeat">
            <input class="input submit mt-1" type="submit"
                   value="<fmt:message bundle="${lang_bundle}" key="user_page.send_sign_up"/>">
        </form>
